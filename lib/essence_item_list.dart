...
class essence_item_list extends StatefulWidget {
  const essence_item_list({Key? key}) : super(key: key);

  @override
  State<essence_item_list> createState() => _essence_item_listState();
}

class _essence_item_listState extends State<essence_item_list> {
