...
class halfsale_item_list extends StatefulWidget {
  const halfsale_item_list({Key? key}) : super(key: key);

  @override
  State<halfsale_item_list> createState() => _halfsale_item_listState();
}

class _halfsale_item_listState extends State<halfsale_item_list> {
