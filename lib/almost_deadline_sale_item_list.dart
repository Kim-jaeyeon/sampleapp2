...
class almost_deadline_sale_item_list extends StatefulWidget {
  const almost_deadline_sale_item_list({Key? key}) : super(key: key);

  @override
  State<almost_deadline_sale_item_list> createState() => _almost_deadline_sale_item_listState();
}

class _almost_deadline_sale_item_listState extends State<almost_deadline_sale_item_list> {
